...
def handle(args: argparse.Namespace, ctx: CommandContext) -> int:
    ...
    try:
        ...
        return 1
    ctx.output.render(listing, kind="learn_discussion")
    return 0
